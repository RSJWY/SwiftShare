...
- **[使用指南](./docs/usage.zh-CN.md)** - 如何使用 SwiftShare
- **[设置说明](./docs/settings.zh-CN.md)** - 各设置项详解
- **[常见问题](./docs/troubleshooting.zh-CN.md)** - 问题排查与解决方案
...
├── docs/                   # 文档（使用指南、设置说明等）
│   ├── usage.zh-CN.md      # 使用指南
│   ├── settings.zh-CN.md   # 设置说明
│   └── troubleshooting.zh-CN.md  # 常见问题
